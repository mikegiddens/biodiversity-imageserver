 ...
 */		 		
						...
						this.myMercZoomLevel=0;
						this.myStyles="default";
...
//Start TOPO Layer
/*
 * Chacking for Config options
 */
		if(Config.General.gmapTypes.TOPO){
					...
					var layer1=[tileDRG];
					var custommap = new GMapType(layer1, G_SATELLITE_MAP.getProjection(), "Topo");
					this.gmap.addMapType(custommap);
			}
 		...
 		* Chacking for Config options
 		*/
		if (Config.General.gmapTypes.DOQQ) {
						...
						var layer2 = [tileDoq];
						var custommap = new GMapType(layer2, G_SATELLITE_MAP.getProjection(), "DOQ");
						this.gmap.addMapType(custommap);
					}	
			}
		if (Config.General.gmapTypes.PHYSICAL) {
