...
$sec_path = CLASS_PATH; // a second location where the scripts should be 
...
// LOGIN_PAGE changed to silver archive page.
define("LOGIN_PAGE", CLASS_PATH."silverarchive.php");
// define("LOGIN_PAGE", CLASS_PATH."login.php");

// define("START_PAGE", "/classes/access_user/example.php");
define("START_PAGE", CLASS_PATH."/example.php");
...
define("WEBMASTER_MAIL", "support@silverbiology.com"); 
define("WEBMASTER_NAME", "SilverBiology Webmaster"); 
define("ADMIN_MAIL", "support@silverbiology.com"); 
define("ADMIN_NAME", "SilverBiology Admin"); 
