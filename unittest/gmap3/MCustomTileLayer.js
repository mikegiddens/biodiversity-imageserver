...
MCustomTileLayer.prototype.getTileUrl = function(a,b) {
	var url = 'http://images.cyberfloralouisiana.com/images/specimensheets/nlu/0/6/32/89/google_tiles/' + + (5 - b) + "/tile_" + (5 - b) + "_" + a.x + "_" + a.y + ".jpg";
	return url;
}
